...
#define IO_DEFAULT_CONFIG             00000001  // pin 0 is output
...
/*----------------------------------------------------------------------------*/
/* Communication peripheral: SPI (UNCOMMENT ALL FOR USE SPI)                  */
/*----------------------------------------------------------------------------*/
...
/**********************************************************************************************************************************************/
#define COMM_SEND_ACK_FRAME             1        // Enable the ACK response frame from communication interface (RS232, SPI)
#define COMM_SEND_ERROR_FRAME           1        // Enable the error response frame from communication interface (RS232, SPI)
